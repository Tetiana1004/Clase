...
<br><br>
<br><br>
<!-------------------center-parte-consulta---------------------->   

	<div class="container" style="border: 2px solid black; background-color:white">
	<div class="container text-center">
			<?php
			$conexion = mysqli_connect("localhost","root","","academia1")or die("problema de conexion");

			$registros=mysqli_query($conexion,"SELECT nombre,identificacion,calificacion FROM notas WHERE identificacion='$_REQUEST[identificacion]'")or die("problema en el select:".mysqli_error($conexion));

			if($reg=mysqli_fetch_array($registros)){
				echo "<h1>"."nombre de estudiante:"."<br>".$reg['nombre']."<br>"."</h1>";
				echo "<h1>"."dentificacion de estudiante:"."<br>".$reg['identificacion']."<br>"."</h1>";
				echo "<h1>"."calificacion de estudiante:"."<br>".$reg['calificacion']."<br>"."</h1>";
...
<!-------------button------->
	...
	<textarea name="enviar" id=""class="form-control" placeholder="Leave a comment here" id="floatingTextarea">Notas</textarea>
